...
const ProductCardTitle: React.FC<ProductCardTitleProps> = ({ icon, className, children, innerClassName, iconY, iconX }) => {
  return (
    <div className={clsx("h-[56px] absolute top-[-28px] rotate-[-5deg] left-1/2 -translate-x-1/2 flex justify-center items-center text-[#F7F9EA] text-center text-stroke-2 font-cherryBomb text-[26px] font-normal leading-none tracking-[2.6px] uppercase", className)}>
